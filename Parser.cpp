...
/// <summary>
/// 根据传入的语法分析单元和产生式调用语义动作
/// </summary>
/// <param name="p">规约所用产生式</param>
/// <param name="items">语法分析单元</param>
/// <returns>语法分析单元，规约后的左部</returns>
...
public:
	...
	ParserItem SDT1(production p, vector<ParserItem> items)
	{
		int t = p.id;
		switch (t)
		{
